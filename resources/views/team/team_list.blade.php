...
{{--                            <th scope="col">Users</th>--}}
                    ...
                    <tbody class="list">
                        ...
                        @else
                            @foreach((array)$data->items() as $team)
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item" href="{{route('master.team_detail',['id' => $team->id])}}">Detail</a>

                                            <a class="dropdown-item" href="{{route('master.team_delete',['id' => $team->id])}}">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
