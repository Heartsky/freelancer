                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item" href="{{route('master_branch_management',['companyId' => $company->id])}}">Branches</a>
                                            <a class="dropdown-item" href="{{route('master_job_management',['companyId' => $company->id])}}">Master Job</a>
