...
@section('breakscrum')
@include('layouts.bars.form_breakscrum',["list" => [ ["title" => __('Add Cash Transaction') , "link" => "#" ]  ], 'link_add' => ''  ])
@endsection
@push('js')
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Add Cash Transaction</h3>
            </div>

            <!-- Card body -->
            <div class="card-body">
                <form method="post" action="{{ route('expense.expense_nrp_save') }}" >
                    @csrf
                    @method('post')
                        ...
                        <div class="col">
                            <div class="form-group">
                                <div class="text-center">
                                    ...
                                    <a href="{{route('expense.expense_nrp_list')}}">
