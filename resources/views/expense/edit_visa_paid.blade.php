...
@section('breakscrum')
@include('layouts.bars.form_breakscrum',["list" => [ ["title" => __('Edit Visa Paid') , "link" => "#" ]  ], 'link_add' => ''  ])
@endsection
@push('js')
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Edit Visa Paid</h3>
            </div>

            <!-- Card body -->
            <div class="card-body">
                <form method="post" action="{{ route('expense.visa_paid_update', ['id' => $item->id]) }}" >
                    @csrf
                    @method('post')
