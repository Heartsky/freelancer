...
@section('breakscrum')
@include('layouts.bars.form_breakscrum',["list" => [ ["title" => __('Edi  Cash Transaction') , "link" => "#" ]  ], 'link_add' => ''  ])
@endsection
@push('js')
...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <!-- Card body -->
            <div class="card-body">
                <form method="post" action="{{ route('expense.expense_nrp_update', ['id' => $item->id]) }}" >
                    @csrf
                    @method('post')
