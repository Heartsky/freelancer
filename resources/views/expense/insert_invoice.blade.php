    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Insert Invoice</h3>
            </div>

            <!-- Card body -->
            <div class="card-body">
                <form method="post" action="{{ route('invoice.invoice_mooney_save') }}" >
                    @csrf
                    @method('post')
                    ...
                    <div class="row  align-items-center">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="item" placeholder="Item" type="text" value="" required>
                            </div>
                        </div>
